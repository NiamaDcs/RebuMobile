    ...
    return ( 
            <View style={styles.container}>
                ...
                <View style={styles.alignMyItem}>
                    <CustomButton label="Se connecter" buttonContainer={styles.loginContainer}  buttonColor={ThemeStyles.color.tint} onPress= { () => console.log('ok')} />
                    <CustomButton label="S'inscrire" buttonContainer={styles.signInContainer} buttonText={styles.signInText} buttonColor={ThemeStyles.color.white} onPress= { () => console.log('ok')} />
                </View>
                </RenderFooter>
            </View>
     );
